...
#class ImageInline(nested.NestedTabularInline):
#    model = Gallery
#    extra = 0
...
#class VariaciyaAdm(nested.NestedModelAdmin):
#    inlines = [ImageInline,]
...
#class VariaciyaInline(nested.NestedStackedInline):
#    inlines = [ImageInline,]
#    model = Variaciya
#    save_on_top = True
#    extra = 0
...
#class TovarAdm(nested.NestedModelAdmin):
